...
export default function Reference({position, data}){
    ...
    return(
        <View style={{ marginTop: 10, lineHeight: 1.3, paddingLeft: position==='left'? 10: 0 }}>
            <Heading title="Reference" height={10} width={14} img={`/icons/white/reference.png`}/>
                {
                    references.map((reference, index)=>(
                        <View style={{ paddingLeft: position==='left'? 5: 10, lineHeight: 1.4, paddingRight: 20 }} key={index}>
