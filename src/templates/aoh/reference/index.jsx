...
export default function Reference({ position, data }){
    ...
    return(
        <View style={{ marginTop: 10, lineHeight: 1.3, paddingLeft: 10 }}>
            <Heading name="Reference" position={position} height={10} width={14} img={`/icons/${position==='left'? 'white': 'black'}/reference.png`}/>
            {
                references.map((reference, index)=>(
                    <View style={{ paddingLeft: 10, lineHeight: 1.4, paddingRight: 20 }} key={index}>
