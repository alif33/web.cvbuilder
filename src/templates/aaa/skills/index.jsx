...
export default function Skills({ position, data }){
    ...
    return(
        <View style={{ marginTop: 10, lineHeight: 1.3, marginBottom: 5, paddingLeft: 10 }}>
            <Heading title="Skills" position={position} height={10} width={10} img="/icons/aoc/skills.png"/>
            <View style={{ paddingRight: 15 }}>
                {
                    skills.map((skill, index)=>(
                        <View style={{position: 'relative', paddingLeft: 15, marginLeft: 2 }} key={index}>
                            ...
                            <View style={{minWidth: '100%', backgroundColor: '#4382C5'}}>
                                <View style={{ maxWidth: `'${skill.percentage}%'`, backgroundColor: '#FFFFFF', minHeight: 5 }}></View>
                            </View>
                            {/* Line */}
